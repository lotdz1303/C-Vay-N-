...
| 2 | Trầm Quốc Hùng | 232818 | Dev AI / Backend | - Xây dựng thuật toán Minimax cho AI. <br> - Tích hợp Alpha-Beta Pruning để tối ưu tốc độ tìm kiếm. <br> - Thiết kế hàm Heuristic Evaluation để đánh giá trạng thái bàn cờ. <br> - Kiểm thử khả năng ra quyết định của AI. |
